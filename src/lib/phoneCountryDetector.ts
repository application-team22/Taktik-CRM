...
const phoneCountryMap: { [key: string]: string } = {
  // Major countries
  '1': 'USA/Canada',
  '7': 'Russia',
  '20': 'Egypt',
...
export function detectCountryFromPhone(phoneNumber: string): string | null {
  ...
  // Remove leading 00 if exists (international format)
...
export function validatePhoneNumber(phoneNumber: string): boolean {
  // Check if phone number is valid (has at least country code + 6 digits)
